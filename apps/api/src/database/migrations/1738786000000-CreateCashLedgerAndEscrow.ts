    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createTable(new Table({
            ...
            columns: [
                ...
                { name: "amount_bs", type: "numeric", precision: 18, scale: 2, default: 0 },
                { name: "amount_usd", type: "numeric", precision: 18, scale: 2, default: 0 },
        ...
        await queryRunner.createIndex("cash_ledger_entries", new TableIndex({
        ...
        await queryRunner.createTable(new Table({
            ...
            columns: [
                ...
                { name: "device_id", type: "uuid" },
                { name: "qty_granted", type: "numeric", precision: 18, scale: 3, default: 0 },
        ...
        await queryRunner.createUniqueConstraint("stock_escrow", new TableUnique({
        ...
        await queryRunner.createIndex("stock_escrow", new TableIndex({
