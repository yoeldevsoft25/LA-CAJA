...
export class ReconciliationService {
    ...
    async reconcilePeriod(
        ...
        this.logger.log(`Iniciando conciliación para tienda ${storeId} del ${startDate.toISOString()} al ${endDate.toISOString()}`);
        ...
        this.logger.log(`Conciliación finalizada. Discrepancias encontradas: ${result.discrepancies.length}`);
        return result;
    }
}
