...
export class CloseCashSessionDto {
  @IsNumber({ maxDecimalPlaces: 2 }, { message: 'El monto en Bs debe tener máximo 2 decimales' })
  ...
  @IsNumber({ maxDecimalPlaces: 2 }, { message: 'El monto en USD debe tener máximo 2 decimales' })
