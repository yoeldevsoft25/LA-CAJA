    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
        <div className="mb-6 sm:mb-8 md:mb-10">
          ...
          <div className="mt-6 sm:mt-8 space-y-6 bg-card p-4 sm:p-6 rounded-3xl border border-border/50 shadow-sm">
            <div>
                ...
                <div className="relative flex-1">
                  ...
                  {hasPublicPin && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2">
                      <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/20 text-[10px] font-bold">ACTIVO</Badge>
                    </div>
                  )}
                </div>
              ...
              return (
                <Card
                  ...
                  className={cn(
                    ...
                    orderIsUrgent ? 'bg-amber-500/10 ring-2 ring-amber-500/40' :
                      orderIsCritical ? 'bg-red-500/10 ring-2 ring-red-500' : 'bg-card'
                  )}
                >
                              ...
                              {item.status === 'preparing' && (
                                <>
                                  <Button
                                    size="lg"
                                    variant="default"
                                    className="h-11 flex-[2] bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs uppercase tracking-widest shadow-lg shadow-emerald-500/10 active:scale-95 transition-all"
                                    onClick={() =>
                                      handleStatusChange(order.id, item.id, item.status, 'next')
                                    }
                                    disabled={updateItemStatusMutation.isPending}
