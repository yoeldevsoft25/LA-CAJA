  ...
  return (
    <FadeInUp className="h-[calc(100vh-4rem)] max-w-7xl mx-auto overflow-y-auto md:overflow-hidden touch-pan-y flex flex-col p-2 lg:p-4" data-pull-to-refresh>
      ...
      <div className={cn(
        ...
        {!isMobile && (
          <div className={cn(
            "flex flex-col h-full overflow-hidden bg-card rounded-2xl border border-border/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-3"
          )}>
            <CatalogHeader
                ...
                <div className="absolute top-full left-0 right-0 z-[100] mt-1 pr-0 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="rounded-xl border border-border/50 bg-card shadow-2xl overflow-hidden border-primary/20">
                    ...
                    <div className="max-h-64 overflow-y-auto overscroll-contain">
                      {products.length === 0 ? (
                        <div className="px-3 py-4 text-sm text-muted-foreground bg-card">
