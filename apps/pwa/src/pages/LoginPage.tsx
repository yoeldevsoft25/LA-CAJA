              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-7">
                ...
                <AnimatePresence mode="wait">
                  {selectedStoreId && (
                    ...
                    >
                      <Label className="text-xs font-semibold tracking-[0.2em] text-muted-foreground flex items-center gap-2 uppercase">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                        Empleado
                      </Label>
                            ...
                            return (
                              <motion.button
                                ...
                                className={cn(
                                  ...
                                  isSelected
                                    ? 'border-primary/60 bg-primary/10 shadow-[0_12px_30px_hsl(var(--primary)_/_0.12)]'
                                    : 'border-border/70 hover:border-primary/35 hover:bg-background bg-background/90 shadow-sm'
                                )}
                  ...
                  {selectedCashierId && (
                    ...
                    >
                      ...
                      <Input
                        ...
                        maxLength={8}
                        className={cn(
                          'h-14 text-center text-2xl tracking-[0.5em] font-semibold border transition-all duration-200 bg-background/90 shadow-sm',
                          'focus:ring-0 focus:ring-offset-0 focus:outline-none focus-visible:outline-none',
                          errors.pin
                            ? 'border-destructive focus:border-destructive'
                            : 'border-border/70 hover:border-primary/35 focus:border-primary/80'
                        )}
                        {...register('pin')}
                        autoFocus
                      />
