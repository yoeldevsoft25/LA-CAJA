...
import { cashService, CashSessionSummary, CashSession } from '@/services/cash.service'
          ...
          {!currentSession ? (
            ...
            <div className="space-y-4">
              ...
              <Alert className="bg-emerald-500/10 border-emerald-500/20">
                ...
                <AlertTitle className="text-emerald-600 dark:text-emerald-400 font-bold">Sesión Activa</AlertTitle>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card className="bg-blue-500/10 border-blue-500/20 shadow-none">
                    <CardContent className="p-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">Apertura</span>
                      </div>
                  ...
                  <Card className="bg-emerald-500/10 border-emerald-500/20 shadow-none">
                    <CardContent className="p-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Apertura Bs</span>
                      </div>
                  ...
                  <Card className="bg-emerald-500/10 border-emerald-500/20 shadow-none">
                    <CardContent className="p-4">
                      <div className="flex items-center mb-2">
                        <DollarSign className="w-4 h-4 text-emerald-500 dark:text-emerald-400 mr-2" />
                        <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Apertura USD</span>
                      </div>
                      <p className="text-lg font-bold text-foreground">
                        ${Number(currentSession.opening_amount_usd).toFixed(2)}
                      </p>
                  ...
                  <Card className="bg-purple-500/10 border-purple-500/20 shadow-none">
                    <CardContent className="p-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider">Ventas</span>
                      </div>
                      <p className="text-lg font-bold text-foreground">
