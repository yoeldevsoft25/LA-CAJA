    ...
    const content = (
        <div className={cn("flex flex-col", items.length === 0 && "h-full justify-center")}>
            {items.length === 0 ? (
                ...
                >
                    <div className="w-20 h-20 sm:w-24 sm:h-24 bg-linear-to-br from-muted to-muted/30 rounded-full flex items-center justify-center mb-6 shadow-inner ring-1 ring-border/40 relative overflow-hidden group">
                        <div className="absolute inset-0 bg-linear-to-tr from-transparent via-foreground/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
