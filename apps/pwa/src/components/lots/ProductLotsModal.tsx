  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-full sm:max-w-2xl flex flex-col p-0 gap-0 border-l border-border shadow-2xl">
        <SheetHeader className="px-5 py-4 border-b border-border flex-shrink-0 bg-card">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-5 py-6 bg-background">
