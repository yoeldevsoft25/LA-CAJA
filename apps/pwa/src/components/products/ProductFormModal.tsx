  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-1 sm:p-4">
      <Card className="max-w-2xl w-full max-h-[85vh] sm:max-h-[90vh] flex flex-col border border-border bg-card">
        {/* Header - Fijo */}
        <CardHeader className="shrink-0 border-b border-border px-3 sm:px-4 py-2 sm:py-3 flex flex-row items-center justify-between rounded-t-lg">
        ...
        >
                          ...
                          return (
                            <div key={item.id} className="flex items-start justify-between gap-3 p-3 border-b last:border-b-0">
                              <div className="min-w-0">
                                <p className="text-sm font-medium text-foreground break-all">{item.product_name}</p>
                ...
                <div className="p-3 bg-card rounded-lg border border-border">
                  <div className="flex items-start justify-between gap-3 min-w-0">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-sm sm:text-base text-foreground wrap-break-word leading-snug flex items-center gap-1.5">
                        ...
                        {previewProduct.category && (() => {
                          ...
                          return <CategoryIcon className="w-3.5 h-3.5 text-muted-foreground/70 shrink-0" />
                        })()}
                        {previewProduct.name}
                      </h3>
                      {previewProduct.category && (
          ...
          <div className="shrink-0 border-t border-border px-3 sm:px-4 md:px-6 py-3 sm:py-4 rounded-b-lg">
