    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          ...
          300: '#7cc8f8',
          400: '#38acf1',
          500: '#0C81CF', // User requested base
          600: '#0967a9',
          700: '#085289',
          800: '#0a4671',
          900: '#0e3b5e',
      ...
      backgroundImage: {
        ...
        'grid-pattern': 'linear-gradient(to right, hsl(var(--foreground) / 0.05) 1px, transparent 1px), linear-gradient(to bottom, hsl(var(--foreground) / 0.05) 1px, transparent 1px)',
      },
      backgroundSize: {
        'dot-sm': '16px 16px',
        'dot-md': '24px 24px',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { opacity: '1', boxShadow: '0 0 20px rgba(13, 129, 206, 0.4)' },
          '50%': { opacity: '0.8', boxShadow: '0 0 40px rgba(13, 129, 206, 0.6)' }
        },
        'float': {
